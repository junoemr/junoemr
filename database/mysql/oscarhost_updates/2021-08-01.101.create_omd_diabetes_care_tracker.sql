...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "WT", "NUMERIC", "Weight", 1, "Weight in kg");
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "HT", "NUMERIC", "Height", 1, "Height in cm");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "WAIS", "NUMERIC", "Waist Circ", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "WHR", "NUMERIC", "Waist to Hip Ratio", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "HDL", "NUMERIC", "HDL", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "EDNL", "BOOLEAN", "Completed", 0, "Education Nutrition");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "MCCS", "BOOLEAN", "Completed", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "ECG", "STRING", "ECG", 0, NULL);
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "PSSC", "BOOLEAN", "Screened", 0, NULL);
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "STRE", "BOOLEAN", "Stress Testing", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "DTYP", "STRING", "type", 0, "1 or 2");
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "A1C", "NUMERIC", "A1C", 1, "Target > 7.0%");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "FBS", "NUMERIC", "Fasting Plasma Glucose", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "FGLC", "BOOLEAN", "Within 20%", 0, "Meter within 20% of simultaneous lab values");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "FBPC", "NUMERIC", "2 hr PC BG", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "HYPE", "NUMERIC", "# of episodes", 1, "Since last assessed");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "MCCN", "BOOLEAN", "Completed", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "MCCE", "BOOLEAN", "Completed", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "SMCD", "STRING", "Challenges", 0, "Self Management Challenges");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "LETH", "BOOLEAN", "Lethargic", 0, "Yearly or As Needed");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "SCR", "NUMERIC", "Serum Creatinine", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "AORA", "BOOLEAN", "ACE-I OR ARB", 0, "Yes No");
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "CRCL", "NUMERIC", "Creatinine Clearance", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "AORA", "BOOLEAN", "Present", 0, "Erectile Dysfunction, gastrointestinal disturbance");
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "FTLS", "BOOLEAN", "Normal", 0, "Check for peripheral anesthesia with 10g monofilament or 128 Hz tuning fork");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "PANE", "BOOLEAN", "Present", 0, NULL);
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "FTE", "BOOLEAN", "Normal", 0, "Foot Care");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "EDF", "BOOLEAN", "Dysfunction", 0, "Yes No");
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "BCTR", "BOOLEAN", "Birth Control", 0, "On Birth Control");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "EYEE", "BOOLEAN", "Exam Done", 0, "Dilated Eye Exam, comment if referred");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "DMME", "BOOLEAN", "Discussed", 0, "Assess and discuss self-management challenges");
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "EDND", "BOOLEAN", "Completed", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "MCCO", "BOOLEAN", "Completed", 0, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "ASAU", "BOOLEAN", "Used", 0, NULL);
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "AST", "NUMERIC", "AST", 1, NULL);
...
CALL addCareTrackerItem(@care_tracker_name, @group_name, "MEASUREMENT", "ALT", "NUMERIC", "ALT", 1, NULL);
