...
CALL careTrackerAddItemGroupProcedure(@care_tracker_name, @group_name, "chronic obstructive pulmonary measurements");
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "FEV1", "BOOLEAN", "Value", 0, "FEV 1 percent of Predicted");
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "CODC", "STRING", "Class", 0, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "02SA", "NUMERIC", "Percent", 1, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "RABG", "BOOLEAN", "Recommended", 0, "Aterial Blood Gas");
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "SKST", "BOOLEAN", "Smoker", 0, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "SMCS", "BOOLEAN", "Discussed", 0, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "SMCP", "STRING", "Program", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "SUO2", "BOOLEAN", "Reviewed", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "NOVS", "BOOLEAN", "Reviewed", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "COPS", "BOOLEAN", "Referred", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "RPPT", "BOOLEAN", "Reviewed", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "PSPA", "BOOLEAN", "Goal", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "COPM", "BOOLEAN", "Reviewed", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "COPE", "BOOLEAN", "Provided", 0, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "PRRF", "BOOLEAN", "Referred", 0, NULL);
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "EPR", "BOOLEAN", "Review/in place", 0, NULL);
...
CALL careTrackerAddItemProcedure(@group_name, "MEASUREMENT", "DOLE", "DATE", "Date", 0, NULL);

-- *** preventions group ***
SET @group_name = "Preventions";
CALL careTrackerAddItemGroupProcedure(@care_tracker_name, @group_name, "chronic obstructive pulmonary preventions");
