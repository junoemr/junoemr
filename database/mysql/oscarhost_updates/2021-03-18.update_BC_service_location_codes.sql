...
INSERT IGNORE INTO billingvisit (`visittype`, `visit_desc`, `region`) VALUES ("L", "Hybrid Primary Care Practice (part-time longitudinal practice, part-time walk-in clinic)", "BC");
