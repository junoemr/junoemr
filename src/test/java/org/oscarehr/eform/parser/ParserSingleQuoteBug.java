...
public class ParserSingleQuoteBug
{
	...
	public ParserSingleQuoteBug(String html, List<String> allNames, List<String> allValues, String expectHtml)
	{
		this.inputHtml = html;
	...
	public void testSetValues()
	{
		...
		//set value twice as the error only happens when deleting a previously saved value field.
