...
public class ReportConfigDaoTest extends DaoTestFixtures
{
	...
	public void testCreate() throws Exception {
		...
		reportConfigDao.persist(entity);
	...
	public void testFindByReportIdAndNameAndCaptionAndTableNameAndSave() throws Exception {
		...
		reportConfigDao.persist(reportConfig1);
		...
		reportConfigDao.persist(reportConfig2);
		...
		reportConfigDao.persist(reportConfig3);
		...
		reportConfigDao.persist(reportConfig4);
		...
		reportConfigDao.persist(reportConfig5);
		...
		reportConfigDao.persist(reportConfig6);
		...
		reportConfigDao.persist(reportConfig7);
		...
		reportConfigDao.persist(reportConfig8);
		
		List<ReportConfig> expectedResult = new ArrayList<ReportConfig>(Arrays.asList(reportConfig4, reportConfig6, reportConfig8));
		List<ReportConfig> result = reportConfigDao.findByReportIdAndNameAndCaptionAndTableNameAndSave(reportId1, name1, caption1, tableName1, save1);
	...
	public void testFindByReportIdAndSaveAndGtOrderNo() throws Exception {
		...
		List<ReportConfig> result = reportConfigDao.findByReportIdAndSaveAndGtOrderNo(reportId1, save1, orderNo1);
