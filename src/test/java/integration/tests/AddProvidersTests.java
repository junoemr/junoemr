...
public class AddProvidersTests extends SeleniumTestBase {
	...
	private static final String[] providerNo = {"100001", "100002", "100003"};
	...
	//private static final String billCenter = "123456789";
	...
	public void addProvidersClassicUITest() throws Exception {
		...
		driver.findElement(By.xpath("//input[@value='team']")).sendKeys(team[0]);
		...
		dropdownSelectByValue(By.xpath("//select[@name='bc_bcp_eligible']"), bcpEligibility);
		...
		driver.findElement(By.xpath("//input[@name='keyword']")).sendKeys(lastNames[0]);
		driver.findElement(By.xpath("//input[@name='button']")).click();
		PageUtil.isExistsBy(By.xpath("//tr[@bgcolor='white']"), driver);
