...
public class CLSHandlerIT extends AbstractMessageHandlerTestBase
{
	...
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(CLSHandler.class);
	...
	protected List<ProviderData> getTestProviders()
	{
		...
		provider5.setAlbertaConnectCareId(E_DELIVERY_ID_C);

		ProviderData provider6 = buildSimpleProvider("6", "match_hso_no", "six");
		provider6.setHsoNo(E_DELIVERY_ID_D);
