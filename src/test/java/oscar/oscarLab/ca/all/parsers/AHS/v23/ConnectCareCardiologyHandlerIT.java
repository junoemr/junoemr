...
public class ConnectCareCardiologyHandlerIT extends AbstractMessageHandlerConnectCareMatchTestBase
{
	@Override
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(ConnectCareCardiologyHandler.class);
