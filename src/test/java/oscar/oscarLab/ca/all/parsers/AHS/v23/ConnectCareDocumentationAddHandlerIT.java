...
public class ConnectCareDocumentationAddHandlerIT extends AbstractMessageHandlerConnectCareMatchTestBase
{
	@Override
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(ConnectCareDocumentationAddHandler.class);
