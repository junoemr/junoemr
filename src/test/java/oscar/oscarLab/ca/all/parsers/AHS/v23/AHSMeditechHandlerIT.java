...
public class AHSMeditechHandlerIT extends AbstractMessageHandlerEDeliveryIdMatchTestBase
{
	@Override
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(AHSMeditechHandler.class);
