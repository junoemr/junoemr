...
public class ConnectCareLabCancelHandlerIT extends AbstractMessageHandlerConnectCareMatchTestBase
{
	@Override
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(ConnectCareLabCancelHandler.class);
