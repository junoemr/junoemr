...
public class ConnectCareDiagnosticImagingCancelHandlerIT extends AbstractMessageHandlerConnectCareMatchTestBase
{
	@Override
	protected MessageHandler getTestHandler()
	{
		...
		MessageHandler testHandler = Mockito.mock(ConnectCareDiagnosticImagingCancelHandler.class);
