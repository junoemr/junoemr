							...
							<html:form action="/oscarEncounter/ViewConsultation" method="get"
								...
								<div style="margin: 0; padding: 0; ">
									...
									<bean:message
										...
										property="searchDate" value="0"
										titleKey="Search on Referal Date"/>
									<bean:message
											key="oscarEncounter.oscarConsultationRequest.ViewConsultationRequests.msgApptDate"/><html:radio
										property="searchDate" value="1"
										titleKey="Search on Appt. Date"/>
							...
							<table border="0" width="90%" cellspacing="1"
								...
								<%
									...
									for (int i = 0; i < theRequests.ids.size(); i++)
									{
										...
										if (isSiteAccessPrivacy || isTeamAccessPrivacy)
										{
											if (providerMap.get(theRequests.providerNo.elementAt(i)) == null)
												continue;
										}
