	...
	<table style="width:1080px; border: solid 1px blue; font-size: x-small; background-color:white;" >
		...
		<tr valign="top" style="border-top:thin dotted blue;">
            ...
            <li>
	            ...
	            {                    
                    ...
                    for(EFormData eForm : allEForms)
                    {
                    	...
                    	url = "/eform/efmshowform_data.jsp?fdid=" + eForm.getId() + "&appointment=null&parentAjaxId=eforms";
                    	date = ConversionUtils.toDateString(eForm.getFormDate(), dateFormat);
						%>
						<li class="eform" title="<%=eFormDisplayName%>" id="<%=docType[2]+eForm.getId()%>">
							<div>
								<div style="float:left; height:20px; line-height:20px; white-space:nowrap;">
									<input class="tightCheckbox1" type="checkbox"
            ...
            <td style="background-color:white; position:relative; width: 850px;">
	            <iframe id="previewPane" style="width:100%; height: 600px; overflow: auto; border:0;" ></iframe>
            </td>
		</tr>
	</table>	
</html:form>
