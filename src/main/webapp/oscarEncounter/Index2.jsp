					...
					<tr>
						<td class="Header"
							...
							<form style="display: inline;" name="ksearch"><select
									name="channel">
								<option
										value="http://res.oscarmcmaster.org/?SUBMIT=Search&advancedSearchF=0&taglist=&query=">
									<bean:message
										...
										<td nowrap>
											<table border="0" cellpadding="0" cellspacing="0" width='100%'>
												<tr>
													<td width='75%'>
														<div class="RowTop"><a href=#
																			   onClick="popupPage(600,700,'<bean:message
															...
															<input id="enTemplate" tabindex="6" autocomplete="off"
																   size="25"
																   type="text" value=""
		...
		<table width="98%" border="1" cellspacing="1" cellpadding="1"
			...
			<tr class="background-color : #ccccff;">
				<td class="wcblayerTitle"><a href=#
											 onClick="hidepic('splitChartLayer');popupPage(600,700,'<bean:message
