								...
								<option
									...
									<bean:message
											key="global.BNF"/></option>
											 ...
											 onkeypress="return grabEnter(event)"/> <input
									type="button"
									name="button" value="Search"
									onClick="popupPage(600,800,'<bean:message
											key="oscarEncounter.Index.popupSearchPageWindow"/>',forms['ksearch'].channel.options[forms['ksearch'].channel.selectedIndex].value+urlencode(forms['ksearch'].keyword.value) ); return false;">
									...
									<tr width="100%">
										...
										<td valign="top">
											...
											<textarea name="shTextarea" tabindex="1" cols="28"
												style="height:<%=windowSizes.getProperty("rowOneSize")%>;overflow:auto"><%=bean.socialHistory%>
											</textarea>
										</td>
										<!-- This is the Family History cell ...fh...-->
										<td valign="top">
											<textarea name="fhTextarea" tabindex="2" cols="28"
												style="height:<%=windowSizes.getProperty("rowOneSize")%>;overflow:auto"><%=bean.familyHistory%>
											</textarea>
										</td>
										<!-- This is the Medical History cell ...mh...-->
										<td valign="top" colspan="2">
											<textarea name="mhTextarea"
												tabindex="3" cols="28"
												style="height:<%=windowSizes.getProperty("rowOneSize")%>;overflow:auto"><%=bean.medicalHistory%>
											</textarea>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td>
								<table bgcolor="#CCCCFF" id="rowTwo" width="100%">
									...
									<tr width="100%">
										<td valign="top"
											style="border-right: 2px solid #ccccff">
											<textarea
												name='ocTextarea' tabindex="4" cols="44"
												style="height:<%=windowSizes.getProperty("rowTwoSize")%>;overflow:auto"><%=bean.ongoingConcerns%>
											</textarea>
										</td>
										<td colspan="2" valign="top">
											<textarea name='reTextarea'
												tabindex="5" cols="44"
												style="height:<%=windowSizes.getProperty("rowTwoSize")%>;overflow:auto"><%=bean.reminders%>
											</textarea>
										</td>
									</tr>
								</table>
													...
													<td align=right>
														<div
															...
															<a
																	...
																	title="<bean:message key="oscarEncounter.Index.tooltipClose"/>">
																<bean:message
																		key="oscarEncounter.Index.x"/></a>
															| <a
																onMouseOver="javascript:window.status='Small Size'; return true;"
																href="javascript:presBoxSmall();"
																title="<bean:message key="oscarEncounter.Index.tooltipSmall"/>">
															<bean:message
																	key="oscarEncounter.Index.s"/></a>
															| <a
																onMouseOver="javascript:window.status='Medium Size'; return true;"
																href="javascript:presBoxNormal();"
																title="<bean:message key="oscarEncounter.Index.tooltipNormal"/>">
															<bean:message
																	key="oscarEncounter.Index.n"/></a>
															| <a
																onMouseOver="javascript:window.status='Large Size'; return true;"
																href="javascript:presBoxLarge();"
																title="<bean:message key="oscarEncounter.Index.tooltipLarge"/>">
															<bean:message
																	key="oscarEncounter.Index.l"/></a>
															| <a
																onMouseOver="javascript:window.status='Full Size'; return true;"
																href="javascript:presBoxFull();"
																title="<bean:message key="oscarEncounter.Index.tooltipFull"/>">
															<bean:message
																	key="oscarEncounter.Index.f"/></a>
															| <a
																onMouseOver="javascript:window.status='Full Size'; return true;"
																href="javascript:reset();"
																title="<bean:message key="oscarEncounter.Index.tooltipReset"/>">
															<bean:message
																	key="oscarEncounter.Index.r"/></a>
														</div>
													</td>
												</tr>
											</table>
							...
							<td>
								<table bgcolor="#CCCCFF" width="100%" id="rowThree">
													...
													<td width='75%'>
														<div class="RowTop"><a href=#
																			   onClick="popupPage(600,700,'
																				   <bean:message
																						   key="oscarEncounter.Index.popupPage2Window"/>','../report/reportecharthistory.jsp?demographic_no=<%=bean.demographicNo%>');return false;">
															<bean:message
																	key="global.encounter"/>: <%=bean.patientLastName %>
															,
															<%=bean.patientFirstName%>
														</a> <%
															if (sChart)
														...
														%> &nbsp; &nbsp; &nbsp;
															...
															<a href="javascript: function myFunction() {return false; }"
															   ...
															   id="splitChartId"> Split
																Chart </a> <%}%>
															<!-- encounter template -->

															<input id="enTemplate" tabindex="6"
									...
									<%
										...
										{
											MiscUtils.getLogger().error("Error", eee);
										}
									%>
									<tr>
										<td colspan="2" valign="top"
											...
											<textarea
												...
												style="height:<%=windowSizes.getProperty("rowThreeSize")%>;overflow:auto"><%=encounterText%>
											</textarea>
										</td>
									</tr>
								</table>
								<table border=0 bgcolor="#CCCCFF" width=100%>
									<tr nowrap>
										...
										<td style="text-align: right" nowrap>
											...
											</oscar:oscarPropertiesCheck> <input type="button"
																				 style="height: 20px;"
											...
											<security:oscarSec roleName="<%=roleName$%>"
												...
												<oscar:oscarPropertiesCheck property="billing_type"
																			value="BC">
													<input type="button" style="height: 20px"
												...
												<security:oscarSec roleName="<%=roleName$%>"
																   objectName="_eChart.verifyButton"
																   rights="w">
													<input type="button" style="height: 20px"
												...
												<% } %>
											</security:oscarSec> <!-- security code block --> <input
												type="button"
											...
											<input type="hidden" name="rowOneSize"
												   value="<%=windowSizes.getProperty("rowOneSize")%>">
											<input
													type="hidden" name="rowTwoSize"
													value="<%=windowSizes.getProperty("rowTwoSize")%>">
											<input
													type="hidden" name="presBoxSize"
													value="<%=windowSizes.getProperty("presBoxSize")%>">
											<input
													type="hidden" name="rowThreeSize"
													value="<%=windowSizes.getProperty("rowThreeSize")%>">
											<input
													type="hidden" name="status" value="t"/> <input
												type="hidden"
												name="appointment_no"
												value="<%=bean.appointmentNo%>"/></td>
									</tr>
								</table>
								<%
									if (bSplit)
