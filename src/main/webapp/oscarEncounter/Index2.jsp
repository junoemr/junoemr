								...
								<table bgcolor="#CCCCFF" id="rowOne" width="100%">
									...
									<tr width="100%">
										...
										<td valign="top">
											...
											<textarea name="shTextarea" tabindex="1" wrap="hard"
													  cols="28"
						...
						<tr>
							<td>
								<table bgcolor="#CCCCFF" id="rowTwo" width="100%">
									...
									<tr width="100%">
										<td valign="top"
											style="border-right: 2px solid #ccccff"><textarea
			...
			<tr class="background-color : #ccccff;">
				<td class="wcblayerTitle"><a href=#
											 onClick="hidepic('splitChartLayer');popupPage(600,700,'
												 <bean:message
														 key="oscarEncounter.Index.popupPage2Window"/>','echarthistoryprint.jsp?echartid=<%=s[0]%>&demographic_no=<%=bean.demographicNo%>');return false;">
					<%=s[1]%>
				</a></td>
