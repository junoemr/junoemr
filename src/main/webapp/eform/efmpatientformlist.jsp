...
<table class="MainTable" id="scrollNumber1" name="encounterTable">
	...
	<tr>
		<td class="MainTableLeftColumn" valign="top">
				...
				<a href="efmpatientformlistinstanced.jsp?demographic_no=<%=demographic_no%>&appointment=<%=appointment%>&parentAjaxId=<%=parentAjaxId%>"><bean:message key="eform.showmyform.btnInstanced"/></a><br/>
