...
<body>
	...
	<% } else { 
			...
			if(k2aUser == null) { %>
				<div>Please authenticate with K2A using your username and password <a href="" onclick="window.open('<%=request.getContextPath()%>/web/#!/settings/integration');">here</a> under the integration tab. Once completed please refresh the page.</div>
			<% } else {
