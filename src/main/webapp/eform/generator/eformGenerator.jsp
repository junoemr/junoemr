...
<head>
	...
	<script>
		...
		var oscarDatabaseTags = ["today", "appt_date", "appt_start_time", "appt_end_time", "next_appt_date",
			...
			"first_last_name", "patient_nameL", "patient_nameF", "patient_alias", "patient_id", "label", "address", "addressline",
			"address_street_number_and_name", "province", "city", "postal", "dob", "dobc", "dobc2", "dobc3", "dob_year",
			"dob_month", "dob_day", "NameAddress", "hin", "hinc", "hinversion", "hc_renew_date", "chartno", "phone",
			"phone2", "cell", "phone_extension", "phone2_extension", "age", "age_in_months", "ageComplex", "ageComplex2",
			"sex", "sin", "name_of_father", "name_of_mother", "licensed_producer_by_demographic", "licensed_producer2_by_demographic",
			"licensed_producer_address_name", "licensed_producer_address_name_list", "licensed_producer_full_address",
			"licensed_producer_full_address_list", "multisite_name_list", "multisite_fax_list", "multisite_phone_list",
			"multisite_full_address_list", "multisite_address_list", "multisite_city_list", "multisite_province_list",
			"multisite_postal_list", "medical_history", "medical_historyc", "other_medications_history",
			"other_medications_historyc", "social_family_history", "social_family_historyc", "ongoingconcerns",
			"ongoingconcernsc", "reminders", "remindersc", "risk_factors_json", "family_history_json", "dxregistry",
			"OHIPdxCode", "allergies_des", "allergies_des_no_archived", "recent_rx", "today_rx", "druglist_generic",
			"druglist_trade", "druglist_line", "latest_echart_note", "onGTPAL", "onEDB", "bcGTPAL", "bcEDD", "doctor",
			"doctor_provider_no", "doctor_ohip_no", "doctor_specialty_code", "doctor_cpsid", "doctor_title",
			"provider_name", "provider_name_first_init", "provider_specialty", "doctor_work_phone", "doctor_fax", "doctor_signature",
			"appt_provider_name", "appt_provider_id", "appt_provider_ohip_no", "appt_no", "referral_name", "referral_fullname",
			"referral_last_name", "referral_address", "referral_addressline", "referral_cityprovpost", "referral_phone",
			"referral_fax", "referral_no", "bc_referral_name", "bc_referral_address", "bc_referral_phone",
			"bc_referral_fax", "bc_referral_no", "clinic_name", "clinic_phone", "clinic_fax", "clinic_label",
			"clinic_addressLine", "clinic_addressLineFull", "clinic_address", "clinic_city", "clinic_province",
			"clinic_postal", "_eform_values_first", "_eform_values_last", "_eform_values_first_all_json",
			"_eform_values_last_all_json", "_eform_values_count", "_eform_values_countname", "_eform_values_count_ref",
			"_eform_values_countname_ref", "_eform_values_count_refname", "_eform_values_countname_refname",
			"_other_id", "dtap_immunization_date", "flu_immunization_date", "fobt_immunization_date",
			"mammogram_immunization_date", "pap_immunization_date", "cytology_no", "guardian_label", "guardian_label2",
			"email", "service_date", "practitioner", "ref_doctor", "fee_total", "payment_total", "refund_total",
			"balance_owing", "bill_item_number", "bill_item_description", "bill_item_service_code", "bill_item_qty",
			"bill_item_dx", "bill_item_amount", "urine_tox_test_json", "methadone_induction_assessment_json",
			"provider_list_json", "ps_referral_name", "ps_referral_last_name", "ps_referral_address",
			"ps_referral_phone", "ps_referral_fax", "ps_referral_no", "family_doctor_name", "family_doctor_last_name",
			"family_doctor_address", "family_doctor_phone", "family_doctor_fax", "family_doctor_no"];
