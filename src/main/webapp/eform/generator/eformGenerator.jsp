...
<head>
	...
	<script>
		...
		var oscarDatabaseTags = [
            ...
            "current_user_specialty",
            "current_user_specialty_code",
            "current_user_cpsid",
            "current_user_id",
            "current_user_signature",
            "current_logged_in_user",
            "current_logged_in_user_address",
            "current_logged_in_user_fax",
            "current_logged_in_user_work_phone",
            "current_logged_in_user_roles",
            "current_logged_in_user_type",
            "current_logged_in_user_id",
            "current_user_takno",
            "current_logged_in_user_takno",
            "patient_name",
            "first_last_name",
            "patient_nameL",
            "patient_nameF",
            ...
            "sex",
            "sin",
            "licensed_producer_by_demographic",
            "licensed_producer2_by_demographic",
            "licensed_producer_address_name",
            "licensed_producer_address_name_list",
            "licensed_producer_full_address",
            "licensed_producer_full_address_list",
            "multisite_name_list",
            "multisite_fax_list",
            "multisite_phone_list",
            "multisite_full_address_list",
            "multisite_address_list",
            "multisite_city_list",
            "multisite_province_list",
            "multisite_postal_list",
            "medical_history",
            ...
            "bill_item_service_code",
            "bill_item_qty",
            "bill_item_dx",
            "bill_item_amount",
            "urine_tox_test_json",
            "methadone_induction_assessment_json",
            "who_measurements",
            "family_doctor_name",
            ...
            "family_doctor_fax",
            "family_doctor_no",
            "bc_family_doctor_name",
            "bc_family_doctor_address",
            "bc_family_doctor_phone",
            "bc_family_doctor_fax",
            "bc_family_doctor_no",
            "roster_status",
        ];
