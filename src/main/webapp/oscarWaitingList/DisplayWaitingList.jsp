				...
				<td class="MainTableTopRowRightColumn" colspan="2" width="85%">
					<table class="TopStatusBar">
						<tr>
							...
							<td>
								<html:select styleId="selectedWL" property="selectedWL">
								<option value=""></option>
								<logic:iterate id="WLWaitingListNameBean" name="waitingListNames">
								<option value="<bean:write name="WLWaitingListNameBean" property="id"/>"><bean:write name="WLWaitingListNameBean"
								                                                                                     property="waitingListName"/></option>
								</logic:iterate>
								...
								%> <INPUT type="button" onClick="popupEditWlNamePage();" value="Create List"> <%
								        } else{
								%> test <%
								}
								%>
									...
									<logic:iterate id="waitingListBean" name="waitingList"
										...
										<tr>
											...
											<td class="<%=styleClass%>"><a href=#
											                               onclick="popupDemographicPage('../demographic/demographiccontrol.jsp?demographic_no=<bean:write
											...
											<td class="<%=styleClass%>"><html:select
												...
												make_appt </a></td>
											<td class="<%=styleClass%>"><a href=#
											                               onClick="removePatient('<bean:write name="waitingListBean" property="demographicNo"/>', '<bean:write
													                               name="WLId"/>');">remove</a>
											</td>
										</tr>
									</logic:iterate>
