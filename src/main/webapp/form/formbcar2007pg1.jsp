...
String formLink = "formbcar2007pg1.jsp";
...
<script type="text/javascript" language="Javascript">
    ...
    function onPrint12() {
        ...
        document.forms[0].action = "../form/formname.do?__title=British+Columbia+Antenatal+Record&__cfgfile=bcar1PrintCfgPg1_2007&__cfgfile=bcar2PrintCfgPg1_2007&__cfgGraphicFile1=bcar2PrintGraphCfgPg1_2007&__graphicPage=2<%= props.getProperty("pg3_date1", "") == "" ? "&__numPages=2&__template=bcarARs2_2007" : "&__numPages=3&__cfgfile=bcar2PrintCfgPg2_2007&__graphicPage=3&__cfgGraphicFile2=bcar2PrintGraphCfgPg1_2007&__template=bcarARs1_2007" %>";
        document.forms[0].target="_blank";            
    ...
    function onPrintAll() {
        ...
        document.forms[0].action = "../form/formname.do?__title=British+Columbia+Antenatal+Record&__cfgfile=bcar1PrintCfgPg1_2007&__cfgfile=bcar2PrintCfgPg1_2007&__cfgGraphicFile1=bcar2PrintGraphCfgPg1_2007&__graphicPage=2<%= props.getProperty("pg3_date1", "") == "" ? "&__numPages=2&__cfgfile=bcar1PrintCfgPg2_2007&__cfgfile=bcar2PrintCfgScores_2007&__template=bcarAll2_2007" : "&__numPages=3&__cfgGraphicFile2=bcar2PrintGraphCfgPg1_2007&__cfgfile=bcar2PrintCfgPg2_2007&__graphicPage=3&__cfgfile=bcar1PrintCfgPg2_2007&__cfgfile=bcar2PrintCfgScores_2007&__template=bcarAll1_2007" %>";
        document.forms[0].target="_blank";            
...
<html:form action="/form/formname">
	...
	<table class="Head" class="hidePrint">
        ...
        %>
			...
			<td align="right"><b>Edit:</b>AR1 | <a
				href="formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2
			<font size=-2>(pg.1)</font></a> | <a
				href="formbcar2007pg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		<tr>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0">
				<tr>
					...
					<input type="text" name="pg1_priCare" style="width: 100%" size="30"
						...
						@oscar.formDB /></td>
					<td colspan="2">Referring Physician/Midwife<br>
				...
				<tr>
					...
					<td valign="bottom">Age at EDD<br>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0">
				<tr>
					<td>Occupation<br>
					<input type="text" name="pg1_work" size="25" maxlength="25"
					...
					<input type="text" name="pg1_workHourDay" size="3" maxlength="5"
						...
						@oscar.formDB /></td>
					<td>No. of school yrs completed<br>
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0">
				<tr>
					<td width="40%" valign="bottom">Partner's Name<br>
					<input type="text" name="pg1_partnerName" style="width: 100%"
						size="20" maxlength="60"
						value="<%= props.getProperty("pg1_partnerName", "") %>"
						@oscar.formDB /></td>
					<td width="5%" valign="bottom">Age <input type="text"
						name="pg1_partnerAge" style="width: 100%" size="2" maxlength="2"
						value="<%= props.getProperty("pg1_partnerAge", "") %>"
						@oscar.formDB /></td>
					<td valign="bottom"><span class="small9">Ethnic Origin
					of<br>
					Newborn's Father</span> <input type="text" name="pg1_faEthOrig"
						id="pg1_faEthOrig" class="spe"
						onDblClick="showHideBox('Origdiv1',1);" style="width: 100%"
						size="20" maxlength="50"
						value="<%= props.getProperty("pg1_faEthOrig", "") %>"
						@oscar.formDB /></td>
					<td valign="bottom">Partner's Work:<br>
					<input type="text" name="pg1_ptWork" size="20" maxlength="40"
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		<tr>
			<td valign="bottom"><b>2.</b> Allergies <input type="checkbox"
				name="pg1_allergyN"
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td><input type="text" name="pg1_birthWeit1" id="pg1_birthWeit1"
				size="4" maxlength="8"
		...
		<tr>
			...
			<td><input type="text" name="pg1_birthWeit2" size="4"
		...
		<tr>
			...
			<td><input type="text" name="pg1_birthWeit3" size="4"
		...
		<tr>
			...
			<td><input type="text" name="pg1_birthWeit4" size="4"
		...
		<tr>
			...
			<td><input type="text" name="pg1_birthWeit5" size="4"
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		<tr>
			...
			<input type="text" name="pg1_lmp" id="pg1_lmp" style="width: 100%"
				...
				dbType="date" /></td>
			<td valign="bottom">Menses Cycle<br>
			<input type="text" name="pg1_mensCycle" style="width: 100%" size="8"
				maxlength="8" value="<%= props.getProperty("pg1_mensCycle", "") %>"
				@oscar.formDB /></td>
			<td>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="30%" valign="bottom">Contraception Method: <br>
					<input type="text" name="pg1_contrMethod" id="pg1_contrMethod"
						class="spe" onDblClick="showHideBox('Contradiv',1);"
						style="width: 100%" size="12" maxlength="15"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td valign="top"><input type="checkbox" name="pg1_deprPsy"
						...
						dbType="tinyint(1)" /></td>
					<td valign="top"><span class="small8">Hx of mental
					illness</span></td>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><input type="checkbox" name="pg1_subUseNo"
								<%= props.getProperty("pg1_subUseNo", "") %>
								<span class="small8">no</span><input type="checkbox" name="pg1_subUseYes" <%= props.getProperty("pg1_subUseYes", "") %><span class="small8">yes</span>
                                </td>
                                <td></td>
                            </tr><tr>
                                <td></td>
                                ...
                                <td colspan="3">
                                    <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td><input type="checkbox" name="pg1_heroin" <%= props.getProperty("pg1_heroin", "") %><span class="small8">Heroin</span></td>
                                            <td><input type="checkbox" name="pg1_cocaine" <%= props.getProperty("pg1_cocaine", "") %><span class="small8">Cocaine</span></td>
                                            <td><input type="checkbox" name="pg1_marijuana" <%= props.getProperty("pg1_marijuana", "") %><span class="small8">Marijuana</span></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="pg1_methadone" <%= props.getProperty("pg1_methadone", "") %><span class="small8">Methadone</span></td>
                                            <td><input type="checkbox" name="pg1_solvents" <%= props.getProperty("pg1_solvents", "") %><span class="small8">Solvents</span></td>
                                            <td><input type="checkbox" name="pg1_subUseOther" <%= props.getProperty("pg1_subUseOther", "") %><span class="small8">Other</span></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="pg1_prescription" <%= props.getProperty("pg1_prescription", "") %><span class="small8">Prescription</span></td>
                                            <td><input type="checkbox" name="pg1_subUseUnknown" <%= props.getProperty("pg1_subUseUnknown", "") %><span class="small8">Unknown</span></td>
                                            <td></td>
                                        </tr>
                                ...
                                <td></td>
                                <td colspan="3"><span class="small8">Cig/day: before pregnancy</span>
                                ...
                                <td><span class="small9">IPV</span></td>
...
<td width="50%" valign="top">
    ...
    <table class="shrinkMe" width="100%" border="0"  cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td><span class="small9">Breasts &amp nipples</span><br>
            ...
            <td></td>
            <td><span class="small9">Varicies &amp skin</span><br>
            ...
            <td><span class="small9">Heart &amp lungs</span><br>
        ...
        <td>
            <!--a href="javascript: popPage('formlabreq.jsp?demographic_no=<%=demoNo%>&formId=0&provNo=<%=provNo%>&labType=AR','LabReq');">LAB</a-->
							...
							<td align="right"><b>View:</b> <a
								href="javascript: popupPage('formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2
							<font size=-2>(pg.1)</font></a> | <a
								href="javascript: popupPage('formbcar2007pg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>&view=1');">AR2
							<font size=-2>(pg.2)</font></a> &nbsp;</td>
							<td align="right"><b>Edit:</b>AR1 | <a
								href="formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2
							<font size=-2>(pg.1)</font></a> | <a
