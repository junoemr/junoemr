									...
									<table>
										...
										<tr>
											...
											<td><input type="text" class="OnExam" name="bimanual"
												value="<%= props.getProperty("bimanual", "") %>" /></td>
										</tr>
										<tr>
											...
											<td><input type="text" class="OnExam" name="adnexa"
												value="<%= props.getProperty("adnexa", "") %>" /></td>
										</tr>
										<tr>
											...
											<td><input type="text" class="OnExam" name="pap"
												value="<%= props.getProperty("pap", "") %>" /></td>
										</tr>
										<tr>
											<td colspan=4>&nbsp;</td>
										</tr>
				...
				<tr>
					...
					<table width=100%>
						...
						<tr>
							...
							AbN, d/c screening age 70</td>
						</tr>
					</table>
					</td>
					<td class="bottomBorder"><textarea class="ToDos" rows=3
						name="toDoPAPs"><%= props.getProperty("toDoPAPs", "") %></textarea></td>
				</tr>
				<tr>
					...
					<td class="bottomBorder"><textarea class="ToDos" rows=3
						name="toDoMammogram"><%= props.getProperty("toDoMammogram", "") %></textarea></td>
