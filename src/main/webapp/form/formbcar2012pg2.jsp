...
String formLink = "formbcar2012pg2.jsp";
    ...
    <script type="text/javascript">
		  ...
		  function reset() {
		   ...
		   function onPrint() {
		       ...
		       if(ret==true)
		       {            
		           document.forms[0].action = "../form/createpdf?__title=British+Columbia+Antenatal+Record+Part+2&__cfgfile=bcar2PrintCfgPg1_2012&__cfgGraphicFile=bcar2PrintGraphCfgPg1_2012&__template=bcar2_2012";
		   ...
		   function onPrintScores() {
		       ...
		       if(ret==true)
		       {            
		           document.forms[0].action = "../form/createpdf?__title=British+Columbia+Antenatal+Record+EPDS/TWEAK+Scores&__cfgfile=bcar2PrintCfgScores_2012&__template=EPDS_TWEAK";
		           document.forms[0].target="_blank";            
		       }
		      return ret;
		   }
...
<table class="Head" class="hidePrint">
    <tr>
        <td align="left">
            ...
            {
            %>
                <input type="submit" style="width:80px;" value="Save" onclick="javascript:return onSave();" />
                <input type="submit" style="width:120px;" value="Save and Exit" onclick="javascript:return onSaveExit();"/>
            <%
            }
            %>
                <input type="submit" style="width:60px;" value="Exit"  name="exitButton" />
                <input type="submit" style="width:80px;" value="Print" onclick="javascript:return onPrint();"/>
                <input type="submit" style="width:140px;" value="Print EPDS/TWEAK" onclick="javascript:return onPrintScores();"/>
                    ...
                    <tr>
                        <td>
                            ...
                            <td colspan="2">
                                ...
                                <input type="text" name="ar2_urineCStxt" value="<%=props.getProperty("ar2_urineCStxt","")%>" maxlength="30" @oscar.formDB /> 
            ...
            <td>
                <table width="100%" border="0"  cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="ar2_labOtherTSH" style="width:100%" size="10" maxlength="30" value="<%= props.getProperty("ar2_labOtherTSH", "") %>" @oscar.formDB />
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td>
               ...
               <tr><td height="20px"></td></tr>
                                <tr>
                <td ><b>FOLLOW UP (internal only)</b></td>
                </tr>
                <tr>
                <td>
                	<textarea name="pg2_followUpCmnt" 
                		cols="70" rows="5"  
                		@oscar.formDB dbType="varchar(255)" ><%= props.getProperty("pg2_followUpCmnt","") %></textarea>                              
                </td>
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="text" name="ar2_proLife" 
                        	style="width:100%" 
                        	size="40" 
                        	maxlength="50" 
                      ...
                      <tr>
                        ...
                        <td>
                        <input type="text" name="ar2_proPreg" 
                        style="width:100%" size="40" 
                        maxlength="50" value="<%= props.getProperty("ar2_proPreg", "") %>" @oscar.formDB />
                        </td>
                      </tr>
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <td>
                        <input type="text" name="ar2_proPostPartum" 
                        style="width:100%" size="40" maxlength="50" 
                        value="<%= props.getProperty("ar2_proPostPartum", "") %>" @oscar.formDB />
                        </td>
                           </tr>
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment1" onmouseover="showHideBox('comment1Div',1)" onmouseout="showHideBox('comment1Div',0)" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment1", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment2" style="width:100%" size="50" maxlength="70" onmouseover="showHideBox('comment2Div',1)" onmouseout="showHideBox('comment2Div',0)" value="<%= props.getProperty("pg2_comment2", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment3" style="width:100%" size="50" maxlength="70" onmouseover="showHideBox('comment3Div',1)" onmouseout="showHideBox('comment3Div',0)" value="<%= props.getProperty("pg2_comment3", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr valign="bottom">
    ...
    <td>
    	<%-- span class="small8"><font color="red">
        ...
        <input type="text" name="pg2_comment4" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment4", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment5" onmouseover="showHideBox('comment5Div',1)" onmouseout="showHideBox('comment5Div',0)" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment5", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment6" style="width:100%" size="50" maxlength="70" onmouseover="showHideBox('comment6Div',1)" onmouseout="showHideBox('comment6Div',0)" value="<%= props.getProperty("pg2_comment6", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment7" style="width:100%" size="50" maxlength="70" onmouseover="showHideBox('comment7Div',1)" onmouseout="showHideBox('comment7Div',0)" value="<%= props.getProperty("pg2_comment7", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment8" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment8", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment9" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment9", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment10" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment10", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment11" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment11", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment12" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment12", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment13" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment13", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment14" style="width:100%" size="50" maxlength="70" onmouseover="showHideBox('comment14Div',1)" onmouseout="showHideBox('comment14Div',0)" value="<%= props.getProperty("pg2_comment14", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment15" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment15", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr>
    ...
    <td>
        <input type="text" name="pg2_comment16" style="width:100%" size="50" maxlength="70" value="<%= props.getProperty("pg2_comment16", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr><td width="23%"></td>
    <td>
        ...
        </table> <!-- end table 18.1 -->
        
        <table width="100%" border="0" cellspacing="2" cellpadding="0">            
            <%-- tr  Removed to accomodate multiple comments for the US.>
        ...
        <td>
        	<input type="text" name="pg2_doula" style="width:100%" size="50" maxlength="100" value="<%= props.getProperty("pg2_doula", "") %>" @oscar.formDB />
        </td>
