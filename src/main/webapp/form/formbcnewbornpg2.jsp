...
%>
			...
			| Part2 <font size=-2>(pg.1)</font> | <a
				href="formbcnewbornpg3.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>">Part2
			...
			<table width="100%" border="1" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td rowspan="2" valign="bottom"><input type="checkbox"
						...
						dbType="tinyint(1)" /> PKU. TSH. GALACTOSEMIA &nbsp; <input
				...
				<tr>
					...
					<td><input type="checkbox" name="ar2_9Test2"
						...
						dbType="tinyint(1)" /> POSITIVE MATERNAL HBsAg STATUS</td>
				</tr>
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ar2_9Test3"
						...
						dbType="tinyint(1)" /> HBIG GIVEN</td>
				</tr>
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="ar2_9Test4"
						...
						dbType="tinyint(1)" /> HEPATITIS B VACCINE GIVEN</td>
				</tr>
				<tr>
					...
					<td><input type="checkbox" name="ar2_9Test5"
						...
						dbType="tinyint(1)" /> POSITIVE MATERNAL HIV STATUS</td>
				</tr>
				<tr>
	...
	<table class="small9" width="100%" border="1" cellspacing="0"
		...
		<tr>
			...
			<textarea name="ar2_14Problem" style="width: 100%" cols="30" rows="3"
				@oscar.formDB dbType="varchar(255)"> <%= props.getProperty("ar2_14Problem", "") %> </textarea>
		...
		<tr>
			...
			<textarea name="ar2_15OtherHospSpec" style="width: 100%" cols="15"
				rows="2" @oscar.formDB dbType="varchar(200)"> <%= props.getProperty("ar2_15OtherHospSpec", "") %> </textarea>
			</td>
			<td>
	...
	<table class="small9" width="100%" border="1" cellspacing="0"
		...
		<tr>
			...
			<td><input type="checkbox" name="ar2_NeoDeath"
				...
				dbType="tinyint(1)" /> AUTOPSY PERFORMED</td>
		</tr>
	</table>
...
<script type="text/javascript">
Calendar.setup({ inputField : "pg2_formDate", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_formDate_cal", singleClick : true, step : 1 });
...
Calendar.setup({ inputField : "pg2_11Date1", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date1_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date2", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date2_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date3", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date3_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date4", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date4_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date5", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date5_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date6", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date6_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date7", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date7_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date8", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date8_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date9", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date9_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date10", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date10_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date11", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date11_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date12", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date12_cal", singleClick : true, step : 1 });
Calendar.setup({ inputField : "pg2_11Date13", ifFormat : "%d/%m/%Y", showsTime :false, button : "pg2_11Date13_cal", singleClick : true, step : 1 });
