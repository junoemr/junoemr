...
String formLink = "formbcar2007pg3.jsp";
...
<table class="Head" class="hidePrint">
    <tr>
        ...
        <td align="right"><b>Edit:</b>
            ...
            <a href="formbcar2007pg2.jsp?demographic_no=<%=demoNo%>&formId=<%=formId%>&provNo=<%=provNo%>">AR2 <font size=-2>(pg.1)</font></a> |
...
<tr>
    ...
    <td>
        <input type="text" name="pg3_comment2" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment2Div',1)" onmouseout="showHideBox('comment2Div',0)" value="<%= props.getProperty("pg3_comment2", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment3" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment3Div',1)" onmouseout="showHideBox('comment3Div',0)" value="<%= props.getProperty("pg3_comment3", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment6" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment6Div',1)" onmouseout="showHideBox('comment6Div',0)" value="<%= props.getProperty("pg3_comment6", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment7" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment7Div',1)" onmouseout="showHideBox('comment7Div',0)" value="<%= props.getProperty("pg3_comment7", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment8" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment8Div',1)" onmouseout="showHideBox('comment8Div',0)" value="<%= props.getProperty("pg3_comment8", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment9" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment9Div',1)" onmouseout="showHideBox('comment9Div',0)" value="<%= props.getProperty("pg3_comment9", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment12" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment12Div',1)" onmouseout="showHideBox('comment12Div',0)" value="<%= props.getProperty("pg3_comment12", "") %>" @oscar.formDB />
           </td>
    <td >
    ...
    <td>
        <input type="text" name="pg3_comment14" style="width:100%" size="50" maxlength="80" onmouseover="showHideBox('comment14Div',1)" onmouseout="showHideBox('comment14Div',0)" value="<%= props.getProperty("pg3_comment14", "") %>" @oscar.formDB />
           </td>
    <td >
...
<tr><td width="23%"></td>
    <td>
        ...
        <td<input type="text" name="pg3_doula" style="width:100%" size="50" maxlength="100" value="<%= props.getProperty("pg3_doula", "") %>" @oscar.formDB /></td>
    </td>
