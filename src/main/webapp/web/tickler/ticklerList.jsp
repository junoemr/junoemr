...
<div ng-show="ticklerReadAccess" class="col-xs-12">
 	
	<form name="searchForm" id="searchForm" class="noprint">
		<div class="row">
			<div class="col-lg-2 col-sm-4 col-xs-6 margin-bottom">
			...
			<div class="col-lg-2 col-sm-3 col-xs-6 margin-bottom">
		...
		<tfoot ng-show="ticklerWriteAccess" class="noprint">   
			<tr>
				<td colspan="12" class="white">
					...
					<button class="btn btn-warning" type="button" ng-click="completeTicklers()"><bean:message key="tickler.list.complete" bundle="ui"/></button>
