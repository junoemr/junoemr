  	...
  	<div class="col-sm-10 col-sm-offset-1">
		<form>
			...
			<div class="form-group col-sm-6">
				...
				<input disabled type="text" class="form-control" value="{{ticklerViewCtrl.ticklerUpdate.updateDate | date:'yyyy-MM-dd'}}" ></input>
			...
			<div class="form-group col-sm-6">
				...
				<juno-datepicker-popup  juno-model="ticklerViewCtrl.serviceDateInput" show-icon="true" type="Input"> </juno-datepicker-popup>
