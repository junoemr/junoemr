...
<div ng-if="me != null">
	...
	<div class="row">
		<div class="col-md-9" ng-controller="DashboardCtrl">
			...
			<!-- il18n problem here -->
			<p class="lead">You have {{(totalInbox>0) && totalInbox || "no"}} report{{(totalInbox>1) && "s" || ""}}{{(totalInbox==0) && "s" || ""}}{{(totalInbox==null)
...
-->
			...
			<p class="lead">You have {{(totalTicklers > 0) && totalTicklers || "no"}} active tickler{{(totalTicklers != 1) && "s" || ""}}. <span style="color:red"
				    ng-if="prefs.expiredTicklersOnly == true">(Overdue)</span></p>
