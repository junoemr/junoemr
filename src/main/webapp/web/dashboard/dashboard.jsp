				...
				<div infinite-scroll="dashboardCtrl.updateFeed(dashboardCtrl.k2afeed.length,10)" infinite-scroll-parent="true">
					<blockquote class="pull-right" ng-repeat="item in dashboardCtrl.k2afeed" ng-class="{'significance-high': item.significance === 'High', 'significance-medium': item.significance === 'Medium', 'significance-low': item.significance === 'Low'}">
						...
						<small>
							...
							<a class="glyphicon glyphicon-thumbs-down" ng-click="dashboardCtrl.disagreeWithK2aPost(item)"></a>&nbsp;{{item.disagreeCount}}&nbsp;&nbsp;
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<div class="row">
											<div class="col-md-7">
												<a class="glyphicon glyphicon-thumbs-up" ng-click="dashboardCtrl.agreeWithK2aPost(item)"></a>&nbsp;<b>{{item.agreeCount}}</b>&nbsp;Agree&nbsp;&nbsp;
												<a class="glyphicon glyphicon-thumbs-down" ng-click="dashboardCtrl.disagreeWithK2aPost(item)"></a>&nbsp;<b>{{item.disagreeCount}}</b>&nbsp;Disagree&nbsp;&nbsp;
										...
										<div>
											...
											<button ng-click="dashboardCtrl.commentOnK2aPost(item)" class="btn btn-default">Save Comment</button>
										</div>
									</div>
								</div>
							</div>
