...
<div class="col-sm-12"  id="consult-request-section">
				...
				<div class="well">
					<form class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-sm-12">
								<label>Address:</label> 
								{{consult.letterheadAddress}}
							</div>
							<div class="col-sm-12">
								<label>Phone:</label> 
								{{consult.letterheadPhone}}
							</div>
							<div class="col-sm-12">
								<label>Fax: </label>
				...
				<div class="well">
					<form class="form-horizontal">
						<div class="form-group">
							<div class="col-sm-6">
								<select id="serviceId" class="form-control"
										...
										ng-required="true"
										ng-change="changeService(consult.serviceId)">
								</select>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<label>Address:</label> 
								{{consult.professionalSpecialist.streetAddress}}
							</div>
							<div class="col-sm-12">
								<label>Phone:</label> 
								{{consult.professionalSpecialist.phoneNumber}}
							</div>
							<div class="col-sm-12">
								<label>Fax: </label>
								{{consult.professionalSpecialist.faxNumber}}
							</div>
						</div>
					</form>
				</div>
				...
				<form class="consult-request-form">
					...
					<div class="form-group col-md-6">
						...
						<%--<input id="dp-appointmentDate" 
							type="text" 
							class="form-control" 
							ng-model="consult.appointmentDate" 
					...
					<div class="form-group col-md-6">
						...
						<div class="input-group bootstrap-timepicker timepicker">
							<input id="timepicker1" type="text" 
								...
								ng-model="consult.appointmentTime"
					...
					<div class="form-group col-md-6">
						...
						<input id="dp-followUpDate" type="text" class="form-control" ng-model="consult.followUpDate" placeholder="Follow Up Date"  datepicker-popup="yyyy-MM-dd" datepicker-append-to-body="true" is-open="page.lfdDatePicker" ng-click="page.lfdDatePicker=true"/>
					</div>
					<div class="form-group col-md-6">
						<label class="control-label">Patient Will Book</label>
						<input class="form-control big-checkbox" type="checkbox" id="willBook" ng-model="consult.patientWillBook"/>
					</div>

					<div class="form-group col-md-12">
						<label class="control-label">Appointment Notes</label>
						<textarea rows="5" class="form-control" ng-model="consult.statusText"></textarea>
					</div>

					<div class="form-group col-md-12">
						<label class="control-label">Reason for Consultation</label>
						<textarea rows="4" class="form-control" ng-model="consult.reasonForReferral"></textarea>
					</div>
					...
					<div class="form-group col-md-12" id="clinical-note"><!-- Clinic Notes -->
							...
							<div class="col-md-12 info-add-buttons">
								<button type="button" class="btn btn-sm btn-success" ng-click="getFamilyHistory('clinicalInfo');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Family History
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getMedicalHistory('clinicalInfo');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Medical History
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getOngoingConcerns('clinicalInfo');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Ongoing Concerns
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getOtherMeds('clinicalInfo');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Other Meds
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getReminders('clinicalInfo');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Reminders
								</button>
							</div>					
					...
					<div class="form-group col-md-12 info-add-buttons" id="concurrent-problem"><!-- Concurrent Problem -->
						<div>
							...
							<div class="col-md-12 info-add-buttons">
								...
								<button type="button" class="btn btn-sm btn-success" ng-click="getFamilyHistory('concurrentProblems');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Family History
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getMedicalHistory('concurrentProblems');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Medical History
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getOngoingConcerns('concurrentProblems');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Ongoing Concerns
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getOtherMeds('concurrentProblems');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Other Meds
								</button>
								<button type="button" class="btn btn-sm btn-success" ng-click="getReminders('concurrentProblems');">
									<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
									Reminders
								</button>
							</div>						
							<textarea id="concurrentProblems" cols="80" rows="5" class="form-control" placeholder="Use the buttons above to insert data from the patients chart"
								ng-model="consult.concurrentProblems">
							</textarea>
						</div>
					</div>
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-12 info-add-buttons">
							<button type="button" class="btn btn-sm btn-success" ng-click="getOtherMeds('currentMeds');">
								<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
								Other Meds
							</button>
						</div>
					...
					<div class="form-group col-md-12"><!-- Alergies / Current Medications -->
						...
						<textarea id="allergies" rows="5" class="form-control" ng-model="consult.allergies"></textarea>
					</div>
				</form>
				<hr>
			</div><!-- Appointment End -->
	...
	<div class="wrapper-action" ng-show="consultReadAccess"><!-- Action Buttons -->
		...
		<button type="button" class="btn btn-large btn-success action" ng-click="save()" ng-show="consultChanged>0">Save</button>&nbsp;
