						...
						<div class="col-md-4">
							<div class="input-group">
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-success flat-btn" ng-click="macPHRDo('Register')" ng-show="page.demo.myOscarUserName==null || page.demo.myOscarUserName==''">
											+<%--<bean:message key="demographic.demographiceditdemographic.msgRegisterPHR"/>--%>
									</button>
								</span>
							</div>
						</div>
