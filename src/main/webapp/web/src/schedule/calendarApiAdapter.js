var CalendarApiAdapter = /** @class */ (function () {
    ...
    CalendarApiAdapter.prototype.get_selected_resources = function (resource_options) {
        ...
        var custom_resource_list = this.get_global_state('schedule_resources');
        if (custom_resource_list === null) {
            custom_resource_list = this.get_global_preference_setting('schedule_resources');
        }
        return this.get_group_resources(custom_resource_list, resource_options);
    };
    CalendarApiAdapter.prototype.get_group_resources = function (default_selections, schedules) {
