class CalendarApiAdapter
{
	...
	public load_schedule_events(providerId, siteName, start, end, view_name, schedule_templates,
	...
	public load_event_statuses()
	{
		...
		this.scheduleService.getAppointmentStatuses().then(
			(results) => {
				deferred.resolve(this.snake_appointment_statuses(results));
			}
		);
	...
	public snake_appointment_statuses(data)
	{
...
/*	public get_group_resources(default_selections, schedules)
	...
	public load_schedule(providerId)
	{
		var deferred = this.$q.defer();
...
/*	public drop_event(uuid, schedule_uuid, delta)
	...
	public save_global_setting(key, value)
	{
