...
<%
	...
	// print header
	{
		...
		sb.append(',');
		sb.append("total encounters by video");
		sb.append(',');
		...
		sb.append(',');
		sb.append("unique clients encountered by video");
		sb.append(',');
	...
	for (ProviderServiceReportUIBean.DataRow row : providerServiceReportUIBean.getDataRows())
	{
		...
		sb.append(',');
		sb.append(row.encounterCounts.nonUniqueCounts.get(EncounterUtil.EncounterType.VIDEO_WITH_CLIENT));
		sb.append(',');
		...
		sb.append(',');
		sb.append(row.encounterCounts.uniqueCounts.get(EncounterUtil.EncounterType.VIDEO_WITH_CLIENT));
		sb.append(',');
