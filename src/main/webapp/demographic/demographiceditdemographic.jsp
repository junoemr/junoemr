...
<html:html locale="true">
	<head>
		...
		<script language="javascript"
				src="<%=request.getContextPath() %>/hcHandler/hcHandler.js"></script>
		<script language="javascript"
				src="<%=request.getContextPath() %>/hcHandler/hcHandlerUpdateDemographic.js"></script>
		<link rel="stylesheet" href="<%=request.getContextPath() %>/hcHandler/hcHandler.css"
			  type="text/css"/>
		<% } %>
		<% if (oscarProps.getBooleanProperty("billingreferral_demographic_refdoc_autocomplete", "true"))
		{ %>
		<link rel="stylesheet" type="text/css"
			  href="<%=protocol%>ajax.googleapis.com/ajax/libs/jqueryui/1.8.17/themes/blitzer/jquery-ui.css"/>
       ...
       adding a calendar a matter of 1 or 2 lines of code. -->
		...
		<script type="text/javascript"
				src="<%=request.getContextPath() %>/js/check_hin.js"></script>
	...
	<table class="MainTable" id="scrollNumber1" name="encounterTable">
					...
					<tr>
						<td>
							...
							<oscar:phrverification
									demographicNo='<%=demographic.getDemographicNo().toString()%>'><bean:message
									key="phr.verification.link"/></oscar:phrverification>

							<span style="margin-left: 20px;font-style:italic">
				<bean:message
						key="demographic.demographiceditdemographic.msgNextAppt"/>: <oscar:nextAppt
		...
		<tr>
				...
				<table border=0 cellspacing=0 width="100%" id="appt_table">
					...
					<tr>
						<td><a
							...
							<bean:message
									key="demographic.demographiceditdemographic.msgWaitList"/></a>
						</td>
					</tr>
				</table>
				<table border=0 cellspacing=0 width="100%">
					...
					<security:oscarSec roleName="<%=roleName$%>" objectName="_billing" rights="r">
						...
						<tr>
							<td>
								...
								<a href="<%=clinicaid_link %>" target="_blank">
									<bean:message
											key="demographic.demographiceditdemographic.msgInvoiceList"/>
								</a>
								<br/>
								<%
									// Old invoice list
								...
								<a href="javascript: function myFunction() {return false; }"
								   onClick="popupPage(500,600,'../billing/CA/ON/billinghistory.jsp?demographic_no=<%=demographic.getDemographicNo()%>&last_name=<%=URLEncoder.encode(demographic.getLastName())%>&first_name=<%=URLEncoder.encode(demographic.getFirstName())%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10')">
									<bean:message
											key="demographic.demographiceditdemographic.msgOldInvoiceList"/></a>
								<%
								}
								else
								{
								...
								<a href="javascript: void();"
								   onclick="return !showMenu('2', event);"
								...
								<a href="javascript: function myFunction() {return false; }"
								   onClick="popupPage(500,600,'../billing/CA/ON/billinghistory.jsp?demographic_no=<%=demographic.getDemographicNo()%>&last_name=<%=URLEncoder.encode(demographic.getLastName())%>&first_name=<%=URLEncoder.encode(demographic.getFirstName())%>&orderby=appointment_date&displaymode=appt_history&dboperation=appt_history&limit1=0&limit2=10')">
									<bean:message
											key="demographic.demographiceditdemographic.msgBillHistory"/></a>
								<%
								}
								else
								{
								...
								<a href="#"
								   onclick="popupPage(800,1000,'../billing/CA/BC/billStatus.jsp?lastName=<%=URLEncoder.encode(demographic.getLastName())%>&firstName=<%=URLEncoder.encode(demographic.getFirstName())%>&filterPatient=true&demographicNo=<%=demographic.getDemographicNo()%>');return false;">
									<bean:message
											key="demographic.demographiceditdemographic.msgInvoiceList"/></a>
						...
						<tr>
							<td><a
									...
									key="demographic.demographiceditdemographic.msgCreateInvoice"/></a>
							</td>
						</tr>
						<% if ("ON".equals(prov))
						{
							...
							if (!oscarProps.getProperty("clinic_no", "").startsWith("1022"))
							{ // part 2 of quick hack to make Dr. Hunter happy
						%>
						<tr>
							<td><a
									href="javascript: function myFunction() {return false; }"
						...
						<tr>
							<td><a
									...
									title="<bean:message key="demographic.demographiceditdemographic.msgBillPatient"/>"><bean:message
									key="demographic.demographiceditdemographic.msgHospitalBilling"/></a>
							</td>
						</tr>
						<tr>
							<td><a
					...
					<tr>
						<td><a
								...
								key="demographic.demographiceditdemographic.btnConsultation"/></a>
						</td>
					</tr>
					<% if (!vLocale.getCountry().equals("BR"))
					{ %>
									...
									<div id='menu1' class='menu'
										...
										<ul>
											...
											<li id="listCustom" style="display: none;"><input
													id="txtCustom" type="text" size="16"
													maxlength="32"
							...
							<tr>
								<td>
									<a href="javascript: function myFunction() {return false; }"
									   ...
									   title="<bean:message key="demographic.demographiceditdemographic.btnEChart"/>">
										<bean:message
												key="demographic.demographiceditdemographic.btnEChart"/></a>
								</td>
							</tr>
						</special:SpecialEncounterTag>
						<tr>
					...
					<plugin:hideWhenCompExists componentName="specialencounterComp" reverse="true">
							...
							<tr>
								<td>
									<a href="#" style="color: brown;"
									   onclick="popupPage(600,800,'<%=request.getContextPath()%>/mod/specialencounterComp/PatientLog.do?method=editPatientLog&demographicNo=<%=demographic_no%>&providerNo=<%=curProvider_no%>&providerName=<%=URLEncoder.encode( userfirstname+" "+userlastname)%>');return false;">patient
										log</a>
								</td>
							</tr>
						</special:SpecialEncounterTag>
						<special:SpecialEncounterTag moduleName="eyeform">
							<tr>
								<td>
									<a href="#" style="color: brown;"
									   onclick="popupPage(600,600,'<%=request.getContextPath()%>/mod/specialencounterComp/EyeForm.do?method=eyeFormHistory&demographicNo=<%=demographic_no%>&providerNo=<%=curProvider_no%>&providerName=<%=URLEncoder.encode( userfirstname+" "+userlastname)%>');return false;">eyeForm
										Hx</a>
								</td>
							</tr>
							<tr>
								<td>
									<a href="#" style="color: brown;"
									   onclick="popupPage(600,600,'<%=request.getContextPath()%>/mod/specialencounterComp/EyeForm.do?method=chooseField&&demographicNo=<%=demographic_no%>&providerNo=<%=curProvider_no%>&providerName=<%=URLEncoder.encode( userfirstname+" "+userlastname)%>');return false;">Exam
										Hx</a>
								</td>
							</tr>
							<tr>
								<td>
									<a href="#" style="color: brown;"
									   onclick="popupPage(600,1000,'<%=request.getContextPath()%>/mod/specialencounterComp/ConReportList.do?method=list&&dno=<%=demographic_no%>');return false;">ConReport
										Hx</a>
					...
					<tr>
						<td><a
							...
							<bean:message
									key="demographic.demographiceditdemographic.msgSendMsg"/></a>
						</td>
					</tr>
					<tr>
						<td><a href="#"
					...
					<oscar:oscarPropertiesCheck property="MY_OSCAR" value="yes">
						<phr:indivoRegistered provider="<%=curProvider_no%>"
							...
							<tr class="Header">
								<td style="font-weight: bold"><bean:message
										key="global.personalHealthRecord"/></td>
							</tr>
							<tr>
								<td>
									<%
										...
										if (auth != null)
											onclickString = "popupOscarRx(600,900,'../phr/PhrMessage.do?method=createMessage&providerNo=" + curProvider_no + "&demographicNo=" + demographic_no + "')";
									%>
									<a href="javascript: function myFunction() {return false; }"
							...
							<tr>
								...
								<td><a href=""
									   onclick="popup(600, 1000, '<%=request.getContextPath()%>/demographic/viewPhrRecord.do?demographic_no=<%=demographic_no%>', 'viewPatientPHR'); return false;">View
									PHR Record</a></td>
							</tr>
					...
					<% if (oscarProps.getProperty("clinic_no", "").startsWith("1022"))
					{ // quick hack to make Dr. Hunter happy
					%>
					<tr>
						<td><a
								href="javascript: function myFunction() {return false; }"
							...
							<td>
								<a href="javascript: function myFunction() {return false; }"
								   onClick="popupPage(710,970,'../dms/documentReport.jsp?function=demographic&doctype=lab&functionid=<%=demographic.getDemographicNo()%>&curUser=<%=curProvider_no%>')"><bean:message
										key="demographic.demographiceditdemographic.msgDocuments"/></a>
							</td>
						</tr>
						<%
							...
							<td>
								<a href="javascript: function myFunction() {return false; }"
								   onClick="popupPage(710,970,'../dms/documentBrowser.jsp?function=demographic&doctype=lab&functionid=<%=demographic.getDemographicNo()%>&categorykey=Private Documents')"><bean:message
										key="demographic.demographiceditdemographic.msgDocumentBrowser"/></a>
							</td>
						</tr>
						<%}%>
						<tr>
							<td><a
									...
									key="demographic.demographiceditdemographic.btnAddDocument"/></a>
							</td>
						</tr>
					</special:SpecialPlugin>
					<special:SpecialEncounterTag moduleName="eyeform">
					...
					<tr>
						<td><a
							...
							<bean:message
									key="demographic.demographiceditdemographic.btnAddEForm"/> </a>
						</td>
					</tr>
				</table>
			</td>
			<td class="MainTableRightColumn" valign="top">
				...
				<div id="mobileDetailSections"
					 style="display:<%=(isMobileOptimized)?"block":"none"%>;">
					<ul class="wideList">
						<% if (!alert.equals(""))
						{ %>
						...
						<% } %>
						<li>
							<a onClick="showHideMobileSections(new Array('demographic'))"><bean:message
									key="demographic.demographiceditdemographic.msgDemographic"/></a>
						</li>
						<li>
							<a onClick="showHideMobileSections(new Array('contactInformation'))"><bean:message
									key="demographic.demographiceditdemographic.msgContactInfo"/></a>
						</li>
						<li>
							<a onClick="showHideMobileSections(new Array('otherContacts'))"><bean:message
									key="demographic.demographiceditdemographic.msgOtherContacts"/></a>
						</li>
						<li>
							<a onClick="showHideMobileSections(new Array('healthInsurance'))"><bean:message
									key="demographic.demographiceditdemographic.msgHealthIns"/></a>
						</li>
						<li>
							<a onClick="showHideMobileSections(new Array('patientClinicStatus','clinicStatus'))"><bean:message
									key="demographic.demographiceditdemographic.msgClinicStatus"/></a>
						</li>
				...
				<table border=0 width="100%">
					...
					<tr>
								...
								<table width="100%" class="demographicDetail">
									<tr>
										<td class="RowTop">
											...
											%><b><span class="rec"><bean:message
												key="demographic.demographiceditdemographic.msgRecord"/> ( <%
						...
						%> ) </span></b>
											...
											%>
											<a id="editBtn"
											   href="javascript: showHideDetail();"><bean:message
									...
									key="demographic.demographiceditdemographic.formFirstName"/>:</span>
																...
																<li>
																	<span class="label"><bean:message
																			key="demographic.demographiceditdemographic.veteranNo"/>:</span>
														...
														<div class="demographicSection"
															...
															<ul>
																...
																<li>
																	<span class="label"><bean:message
																			key="demographic.demographiceditdemographic.motherName"/>:</span>
																	<span class="info"><%= nameOfMother %></span>
																</li>
																<li>
																	<span class="label"><bean:message
																			key="demographic.demographiceditdemographic.fatherName"/>:</span>
														...
														<div class="demographicSection"
															...
															<ul>
																...
																<li><span
																	...
																	<span class="info"><%=apptMainBean.getString(demoExt.get("cytolNum"))%></span>
																</li>
																<li><span
																		class="label"><bean:message
														...
														<div class="demographicSection"
															...
															<ul>
																...
																<li><span
																	...
																	<span class="info"><%=apptMainBean.getString(demoExt.get("demo_cell"))%></span>
																</li>
																<li><span
																		class="label"><bean:message
							...
							<bean:message
									key="demographic.demographiceditdemographic.formProcvince"/> <%
																	...
																	<span class="info"><%=demographic.getProvince()%></span>
																</li>
																<li><span class="label"> <%
							...
							<bean:message
									key="demographic.demographiceditdemographic.formPostal"/> <%
																	...
																	<span class="info"><%=demographic.getPostal()%></span>
																</li>
																<li><span
																		class="label"><bean:message
															...
															<div style="background-color: #EEEEFF;">
																<ul>
																	...
																	<li>
																		...
																		<% } %>:
																		<b><%=providerBean.getProperty(apptMainBean.getString(rs, "provider_no"), "")%>
																		</b>
							...
							<bean:message
									key="demographic.demographiceditdemographic.formDoctor"/>
                                                    ...
                                                    <%}%>
																...
																<li><span
																		...
																		class="info"><%=providerBean.getProperty(resident, "")%></span>
																</li>
																<li><span
																		class="label"><bean:message
																		key="demographic.demographiceditdemographic.formMidwife"/>:</span><span
																		class="info"><%=providerBean.getProperty(midwife, "")%></span>
																</li>
																<li><span
																		class="label"><bean:message
																		key="demographic.demographiceditdemographic.formResident"/>:</span>
																	<span class="info"><%=providerBean.getProperty(nurse, "")%></span>
																</li>
																<li><span
																		class="label"><bean:message
												...
												<div class="demographicSection" id="special">
													...
													{%> <%=propDemoExt[k] + ": <b>" + apptMainBean.getString(demoExt.get(propDemoExt[k].replace(' ', '_'))) + "</b>"%>
											...
											<table width="100%" bgcolor="#EEEEFF" border=0
												...
												<tr>
													...
													<td align="left"><input type="text"
																			...
																			size="30"
																			value="<%=demographic.getFirstName()%>"
																			onBlur="upCaseCtrl(this)">
													</td>
												</tr>
												<tr>
												...
												<tr valign="top">
													<td align="right"><b><bean:message
															key="demographic.demographiceditdemographic.formPhoneH"/><% if (custom_required_fields.contains("phone"))
													...
													<td align="left">
														<input type="text" name="phone"
															   ...
															   value="<%=demographic.getPhone()%>">
														<bean:message
																key="demographic.demographiceditdemographic.msgExt"/>:<input
															type="text"
															name="hPhoneExt" <%=getDisabled("hPhoneExt")%>
													...
													<td align="right"><b><bean:message
															key="demographic.demographiceditdemographic.formPhoneW"/><% if (custom_required_fields.contains("phone2"))
													{%><font color="red">:</font> </b><% }
													else
													{ %>:<%} %></b></td>
													<td align="left"><input type="text"
																			...
																			style="display: inline; width: auto;"
																			value="<%=demographic.getPhone2()%>">
														<bean:message
																key="demographic.demographiceditdemographic.msgExt"/>:<input
																type="text"
																name="wPhoneExt" <%=getDisabled("wPhoneExt")%>
												...
												<tr valign="top">
													<td align="right"><b><bean:message
															key="demographic.demographiceditdemographic.formPhoneC"/><% if (custom_required_fields.contains("cellphone"))
													{%><font color="red">:</font> </b><% }
													else
													{ %>:<%} %> </b></td>
													<td align="left">
												...
												<tr valign="top">
													<td align="right"><b><bean:message
															key="demographic.demographiceditdemographic.formEmail"/><% if (custom_required_fields.contains("email"))
													{%><font color="red">:</font> </b><% }
													else
													{ %>:<%} %> </b></td>
													<td align="left"><input type="text" name="email"
														...
														{%>
														<input type="checkbox"
															   name="email_checkbox"/> Not available
														<%}%>
													</td>
													<td align="right"><b><bean:message
															key="demographic.demographiceditdemographic.formMyOscarUserName"/>: </b>
													</td>
													<td align="left"><input type="text"
														...
														<%
															...
															PHRAuthentication auth = MyOscarUtils.getPHRAuthentication(session);
															if (auth == null)
																onclickString = "alert('Please login to MyOscar first.')";
														%>
														<a href="javascript:"
														   onclick="<%=onclickString%>"><sub
																style="white-space: nowrap;"><bean:message
																key="demographic.demographiceditdemographic.msgRegisterMyOSCAR"/></sub></a> <%}%>
													</td>
												</tr>
												<tr valign="top">
													<td align="right"><b><bean:message
												...
												<tr valign="top">
													...
													<td align="left" nowrap><input type="text"
																				   name="hin" <%=getDisabled("hin")%>
																				   value="<%=demographic.getHin()%>"
																				   size="17">
														<b><bean:message
																key="demographic.demographiceditdemographic.formVer"/></b>
														<input
																type="text"
																name="ver" <%=getDisabled("ver")%>
																value="<%=demographic.getVer()%>"
																size="3"
													...
													<td align="left">
														...
														%> <input type="text"
																  ...
																  size="4" maxlength="4"
																  value="<%= effDateYear%>"> <input
															type="text" name="eff_date_month"
															size="2"
															maxlength="2" <%=getDisabled("eff_date_month")%>
															value="<%= effDateMonth%>"> <input
															type="text"
															name="eff_date_date" size="2"
														...
														%>
														<input type="text" name="hc_renew_date_year"
															   size="4" maxlength="4"
															   value="<%=renewDateYear%>" <%=getDisabled("hc_renew_date_year")%>>
														<input type="text"
															   name="hc_renew_date_month" size="2"
															   maxlength="2"
															   value="<%=renewDateMonth%>" <%=getDisabled("hc_renew_date_month")%>>
														<input type="text" name="hc_renew_date_date"
															   size="2" maxlength="2"
												...
												<tr valign="top">
													...
													{%>
														...
														<select name="hc_type"
															...
															{%>
															<option value="NF" <%=hctype.equals("NF") ? " selected" : ""%>>
												...
												<tr valign="top">
													...
													<td align="left"><select
															name="resident" <%=getDisabled("resident")%>
															style="width: 200px">
														<option value=""></option>
														<%
															rsdemo.close();
												...
												<tr valign="top">
													...
													<td align="left"><select name="nurse"
																			 style="width: 200px" <%=getDisabled("nurse")%>>
														<option value=""></option>
														<%
															rsdemo.close();
															rsdemo = apptMainBean.queryResults("search_provider_doc");
														...
														<option value="<%=rsdemo.getString("provider_no")%>"
															...
															<%=Misc.getShortStr((apptMainBean.getString(rsdemo, "last_name") + "," + apptMainBean.getString(rsdemo, "first_name")), "", nStrShowLen)%>
														</option>
														<% } %>
													</select></td>
												</tr>
												...
												<tr valign="top">
													...
													<td align="left">
														<input type="text" name="roster_date_year"
															   size="4" maxlength="4"
															   value="<%=rosterDateYear%>">
														<input type="text" name="roster_date_month"
															   size="2" maxlength="2"
															   value="<%=rosterDateMonth%>">
														<input type="text" name="roster_date_day"
															   size="2" maxlength="2"
															   value="<%=rosterDateDay%>">
														<b><bean:message
																key="demographic.demographiceditdemographic.RosterTerminationDate"/>: </b>
														<input type="text"
															   name="roster_termination_date_year"
															   size="4" maxlength="4"
															   value="<%=rosterTerminationDateYear%>">
														<input type="text"
															   name="roster_termination_date_month"
															   size="2" maxlength="2"
															   value="<%=rosterTerminationDateMonth%>">
														<input type="text"
															   name="roster_termination_date_day"
															   size="2" maxlength="2"
												...
												<tr valign="top">
													...
													<td align="left">
														<% if (vLocale.getCountry().equals("BR"))
														{ %> <%
														String pacStatus = demographic.getPatientStatus();
														if (pacStatus == null)
														{
															pacStatus = "";
														}
													%> <input type="hidden"
															  name="initial_patientstatus"
															  value="<%=pacStatus%>">
													...
													else
													{
														...
														<select name="patient_status"
															...
															<%
																...
																{ %>
															<option
																	<%=patientStatus.equals(rsstatus.getString("patient_status")) ? " selected" : ""%>><%=rsstatus.getString("patient_status")%>
															</option>
															<% }
																rsstatus.close();
																// end while %>
													...
													<td align="left">
														<input type="text"
															   name="patientstatus_date_year"
															   size="4" maxlength="4"
															   value="<%=patientStatusDateYear%>">
														<input type="text"
															   name="patientstatus_date_month"
															   size="2" maxlength="2"
															   value="<%=patientStatusDateMonth%>">
														<input type="text"
															   name="patientstatus_date_day"
															   size="2" maxlength="2"
												...
												<tr>
													<td align="right"><b><bean:message
															key="demographic.demographicaddrecordhtm.motherName"/>:</b>
													</td>
													<td align="left">
												...
												<tr>
													<td align="right"><b><bean:message
															key="demographic.demographicaddrecordhtm.fatherName"/>:</b>
													</td>
													<td align="left">
												...
												<tr>
													<td align="right"><b><bean:message
															key="demographic.demographicaddrecordhtm.veteranNo"/>:</b>
													</td>
													<td align="left">
												...
												<tr>
													...
													<td align="left"><input type="text"
																			name="chart_no"
																			size="30"
																			value="<%=demographic.getChartNo()%>" <%=getDisabled("chart_no")%>>
													</td>
													<!-- Scanned Chart -->
													<% if (oscarProps.isPropertyActive("demographic_scanned_chart"))
													{ %>
													<td align="right" nowrap><b><bean:message
															key="demographic.demographiceditdemographic.scannedChart"/>:</b>
													</td>
													<td align="left"><input type="checkbox"
																			name="scanned_chart"
																			value="scanned" <%=demographic.getScannedChart().equals("1") ? "checked" : ""%>/>
													</td>
												</tr>
												<% } %>
												</tr>
														...
														<table border="1" width="100%">
															...
															<tr>
																...
																<td align="left"><input type="text"
																		...
																		src="../images/cal.gif"
																		id="referral_date_cal"><bean:message
												...
												<tr valign="top">
													...
													<td align="left">
														...
														%> <input type="text"
																  name="date_joined_year" size="4"
																  maxlength="4"
																  value="<%= dateJoinedYear %>">
														<input type="text"
															   name="date_joined_month" size="2"
															   maxlength="2"
															   value="<%= dateJoinedMonth %>">
														<input type="text"
															   name="date_joined_date" size="2"
															   maxlength="2"
													...
													<td align="left">
														...
														%> <input type="text" name="end_date_year"
																  size="4" maxlength="4"
																  value="<%= endYear %>"> <input
															type="text" name="end_date_month"
															size="2" maxlength="2"
															value="<%= endMonth %>"> <input
															type="text"
															name="end_date_date" size="2"
															maxlength="2"
															value="<%= endDay %>"></td>
												</tr>
												<% // customized key
												...
												<tr valign="top" bgcolor="#CCCCFF">
													<td align="right" nowrap><b><%=propDemoExt[k]%>
														: </b></td>
													<td align="left">
														<% if (bExtForm)
														{
												...
												<tr valign="top">
													<td nowrap colspan="4">
														...
														<oscar:oscarPropertiesCheck
															...
															<input type="hidden"
																   name="primaryEMROrig"
																   value="<%=apptMainBean.getString(demoExt.get("primaryEMR"))%>"/>
															<select id="primaryEMR"
																	name="primaryEMR">
														...
														<table width="100%" bgcolor="#EEEEFF">
															<tr>
																<td width="7%" align="right"><font
																		color="#FF0000"><b><bean:message
																		key="demographic.demographiceditdemographic.formAlert"/>: </b></font>
																</td>
																<td><textarea name="alert"
																			  style="width: 100%"
																			  cols="80"
																			  rows="2"><%=alert%></textarea>
																</td>
															</tr>
															<tr>
																<td align="right"><b><bean:message
									...
									<input type="submit"
										   value="<bean:message key="demographic.demographiceditdemographic.btnUpdate"/>">
											...
											<input type="button"
												   value="Compare with Integrator" <%=styleBut%>
											...
											<input type="button"
												   value="Send note to integrated provider"
