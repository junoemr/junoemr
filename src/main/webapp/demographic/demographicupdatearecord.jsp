...
<%
  ...
  demographic.setFamilyDoctor("<rdohip>" + request.getParameter("referral_doctor_ohip") + "</rdohip><rd>" + request.getParameter("referral_doctor_name") + "</rd>" + (request.getParameter("family_doc")!=null? ("<family_doc>" + request.getParameter("family_doc") + "</family_doc>") : ""));
  demographic.setFamilyDoctor2("<fd>" + request.getParameter("family_doctor_ohip") + "</fd>" + (request.getParameter("family_doctor_name")!=null? ("<fdname>" + request.getParameter("family_doctor_name") + "</fdname>") : ""));
  ...
  if(oscarVariables.isPropertyActive("demographic_parent_names")) {
	...
	if (oscarVariables.isPropertyActive("demographic.showReferralSource"))
	{
		...
		Integer referralSourceID = DemographicManager.fetchReferralSourceID(referralSourceParam, newReferralSource);
