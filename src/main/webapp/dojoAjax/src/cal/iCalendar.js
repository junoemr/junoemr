...
dojo.extend(dojo.cal.iCalendar.VEvent, {
		getDates: function(until) {
			...
			// TODO-legacy: add rdates to the recurrance set here

			// TODO-legacy: subtract exdates from the recurrance set here

			//TODO-legacy:  subtract dates generated by exrules from recurranceSet here
