...
<div style="height:600px; overflow:auto;">
	...
	%>
		...
		<dt>
			<img id="plus<%=patientId%>" alt="plus"
				 src="<%=request.getContextPath()%>/images/plus.png"
				 onclick="showhideSubCat('plus','<%=patientId%>');"/>
			<img id="minus<%=patientId%>" alt="minus" style="display:none;"
				 src="<%=request.getContextPath()%>/images/minus.png"
				 onclick="showhideSubCat('minus','<%=patientId%>');"/>
			<a id="patient<%=patientId%>all"
	...
	%>
		...
		<dt>
			<img id="plus0" alt="plus"
				 src="<%=request.getContextPath()%>/images/plus.png"
				 onclick="showhideSubCat('plus','0');"/>
			<img id="minus0" alt="minus" style="display:none;"
				 src="<%=request.getContextPath()%>/images/minus.png"
				 onclick="showhideSubCat('minus','0');"/>
...
<head>
	...
	<script type="text/javascript" >
		...
		window.changePage = function changePage(nextPage)
		{
			if (nextPage === "Next") { page++; }
			else if (nextPage === "Previous") { page--; }
			else { page = nextPage; }
		...
		function handleScroll(e)
		{
			...
			var loadMore = false;
			if (isListView && evt.scrollHeight > $("listViewDocs").clientHeight &&
				evt.scrollTop > 0 &&
				evt.scrollTop + evt.offsetHeight + 5 >= evt.scrollHeight)
			{
				loadMore = true;
			}
