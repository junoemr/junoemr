...
import org.oscarehr.consultations.service.ServiceSpecialistsService;
...
public class EctConDisplayServiceAction extends Action
{
	...
	private static ServiceSpecialistsService serviceSpecialistsService = SpringUtils.getBean(ServiceSpecialistsService.class);
			...
			throws ServletException, IOException
	{
		...
		serviceSpecialistsService.updateServiceSpecialists(Integer.parseInt(serviceId), Arrays.asList(specialists));
