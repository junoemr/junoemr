...
public class EctDisplayRxAction extends EctDisplayAction {
    ...
    public boolean getInfo(EctSessionBean bean, HttpServletRequest request, NavBarDisplayDAO Dao, MessageResources messages) {
        ...
        String leftUrl="RpopupPage(580,1027,'" + winName + "','" + request.getContextPath() + "/oscarRx/choosePatient.do?providerNo=" + bean.providerNo + "&demographicNo=" + bean.demographicNo + "')";
        String url = "popupPage(580,1027,'" + winName + "','" + request.getContextPath() + "/oscarRx/choosePatient.do?providerNo=" + bean.providerNo + "&ltm=true" + "&reRxExpiredLTM=true" + "&s=true" + "&demographicNo=" + bean.demographicNo + "')";
