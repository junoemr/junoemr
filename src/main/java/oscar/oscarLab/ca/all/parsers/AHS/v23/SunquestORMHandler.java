...
public class SunquestORMHandler extends SunquestHandler
{
	...
	public SunquestORMHandler(Message msg) throws HL7Exception
	{
		super(msg);
	}
	...
	public String getServiceDate()
	{
		 ...
		 * The year is used to construct a unique accession number in sunquest labs,
		 * so this will cause some issues if the year of service and the observation date are different. */
		if (serviceDate == null || serviceDate.isEmpty())
		{
