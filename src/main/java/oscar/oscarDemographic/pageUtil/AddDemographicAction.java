...
public class AddDemographicAction extends Action
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
	{
		...
		year = request.getParameter("year_of_birth");
		month = request.getParameter("month_of_birth") != null && request.getParameter("month_of_birth").length() == 1 ? "0" + request.getParameter("month_of_birth") : request.getParameter("month_of_birth");
		day = request.getParameter("date_of_birth") != null && request.getParameter("date_of_birth").length() == 1 ? "0" + request.getParameter("date_of_birth") : request.getParameter("date_of_birth");
		...
		demographic.setDateOfBirth(localDate);
...
*/
		...
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "hPhoneExt", request.getParameter("hPhoneExt")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "wPhoneExt", request.getParameter("wPhoneExt")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "demo_cell", request.getParameter("demo_cell")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "aboriginal", request.getParameter("aboriginal")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "cytolNum", request.getParameter("cytolNum")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "ethnicity", request.getParameter("ethnicity")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "area", request.getParameter("area")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "statusNum", request.getParameter("statusNum")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "fNationCom", request.getParameter("fNationCom")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "given_consent", request.getParameter("given_consent")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "rxInteractionWarningLevel", request.getParameter("rxInteractionWarningLevel")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "primaryEMR", request.getParameter("primaryEMR")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "aboriginal", request.getParameter("aboriginal")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "phoneComment", request.getParameter("phoneComment")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "usSigned", request.getParameter("usSigned")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "privacyConsent", request.getParameter("privacyConsent")));
		extensions.add(new DemographicExt(providerNo, demographic.getDemographicId(), "informedConsent", request.getParameter("informedConsent")));
		...
		if (oscarVariables.getProperty("demographicExt") != null)
		{
			...
			{
				//demographicExtDao.addKey(providerNo,demographic.getDemographicId(),propDemoExt[k],request.getParameter(propDemoExt[k].replace(' ','_')),"");
		...
		if(oscarVariables.isPropertyActive("show_demographic_licensed_producers")) {
			try {
				...
				demographicDao.saveDemographicLicensedProducer(demographic.getDemographicId(), licensedProducerID, licensedProducerID2, licensedProducerAddressID);
			}
		...
		*/
		...
		Long archiveId = demographicArchiveDao.archiveRecord(demographicDao.getDemographic(demoNo));
		List<DemographicExt> extensions = demographicExtDao.getDemographicExtByDemographicNo(Integer.parseInt(demoNo));
