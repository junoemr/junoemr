...
{
	public static final String DEFAULT_PAYEE_NAME = "Clinic";
	...
	private boolean addDrToName = true;
	...
	public boolean isAddDrToName()
	{
		return addDrToName;
	}

	public void setAddDrToName(boolean addDrToName)
	{
		this.addDrToName = addDrToName;
	}
