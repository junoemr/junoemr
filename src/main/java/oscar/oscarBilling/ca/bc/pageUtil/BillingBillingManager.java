...
public class BillingBillingManager {
  ...
  public BillingItem[] getBillingItem(String[] service, String service1,
                                      ...
                                      String service1unit, String service2unit,
                                      String service3unit) {
    BillingItem[] arr = {};
    ...
    try {
      ...
      for (int i = 0; i < lst.size(); i++) {
        ...
        while (rs.next()) {
          billingitem = new BillingItem(rs.getString("service_code"),
                                        rs.getString("description"),
                                        rs.getString("value"),
                                        rs.getString("percentage"), units);
          lst.add(billingitem);
        }
    ...
    try {
      ...
      while (rs.next()) {
        ...
        if (billingType.equals("WCB")) {
          ResultSet wcbrs = DBHandler.GetSQL(
          ...
          billingCode = rs.getString("billing_code");
  ...
  public class BillingItem {
    ...
    public BillingItem(String service_code, String description, String price1,
                       String percentage1, double units1) {
