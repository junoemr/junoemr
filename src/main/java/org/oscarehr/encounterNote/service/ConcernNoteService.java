...
import org.oscarehr.demographicImport.converter.in.note.ConcernNoteModelToDbConverter;
...
public class ConcernNoteService extends HistoryNoteService
{
	@Autowired
	protected ConcernNoteModelToDbConverter concernNoteModelToDbConverter;

	public CaseManagementNote saveConcernNote(ConcernNote noteModel, Demographic demographic)
	{
