...
@Component
public class ReminderNoteDbToModelConverter extends
		BaseNoteDbToModelConverter<org.oscarehr.dataMigration.model.encounterNote.ReminderNote>
{

	@Override
	public org.oscarehr.dataMigration.model.encounterNote.ReminderNote subConvert(
			CaseManagementNote input,
			org.oscarehr.dataMigration.model.encounterNote.ReminderNote exportNote)
	{
	...
	@Override
	public org.oscarehr.dataMigration.model.encounterNote.ReminderNote getNewNoteObject()
	{
		return new org.oscarehr.dataMigration.model.encounterNote.ReminderNote();
	}
}
