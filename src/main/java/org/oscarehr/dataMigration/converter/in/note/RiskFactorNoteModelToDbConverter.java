...
@Component
public class RiskFactorNoteModelToDbConverter extends BaseNoteModelToDbConverter<RiskFactorNote>
{
	@Override
	public CaseManagementNote subConvert(
			RiskFactorNote input,
			CaseManagementNote dbNote)
	{
		...
		if(input.getExposureDetails() != null)
		{
			dbNote.addExtension(getExt(dbNote, CaseManagementNoteExt.EXPOSUREDETAIL, input.getExposureDetails()));
		}
