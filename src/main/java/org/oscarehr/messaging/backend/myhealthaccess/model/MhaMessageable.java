...
@Data
public class MhaMessageable implements Messageable<MhaMessageable>
{
	protected String id;
	...
	@Override
	public MhaMessageable getEntity()
	{
		// In the future this could return MHAPatient, MHAClinicUser, MHAClinic etc.
		return this;
	}
}
