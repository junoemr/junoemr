...
public class IncomingFaxService
{
	...
	public FaxInbound saveFaxDocument(final FaxAccount faxAccount, final GenericGetFaxInboxResult inboxMeta, String result) throws IOException, InterruptedException
	{
