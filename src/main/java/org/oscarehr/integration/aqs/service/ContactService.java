...
import org.oscarehr.integration.aqs.conversion.ContactContactDtoConverter;
...
public class ContactService extends BaseService
{
	...
	public Contact createNewContact(Contact contact, Integer securityNo)
	{
		...
		{
			throw new AqsCommunicationException("Failed to create contact on AQS server", apiException);
		}
	}
}
