...
public class ERP_R09_NOTE extends AbstractGroup
{
	public ERP_R09_NOTE(Group parent, ModelClassFactory factory)
	{
	...
	private void init(ModelClassFactory factory)
	{
		try
		{
			this.add(NTE.class, true, false, false);
			this.add(ZNT.class, true, false, false);
		}
	...
	public ZNT getZNT()
	{
		return this.getTyped("ZNT", ZNT.class);
	}
}
