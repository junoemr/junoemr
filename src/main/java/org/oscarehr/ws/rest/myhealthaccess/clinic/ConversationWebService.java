...
@Path("myhealthaccess/integration/{integrationId}/clinic/conversation/")
@Component("mhaClinicConversationWebService")
@Tag(name = "mhaClinicMessaging")
public class ConversationWebService extends MessagingBaseWebService
{
	// ==========================================================================
	// Public Methods
	// ==========================================================================
	...
	@Autowired
	public ConversationWebService(MessagingServiceFactory messagingServiceFactory, IntegrationDao integrationDao)
	{
	...
	public RestResponse<ConversationDto> getConversation(
