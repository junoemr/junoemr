...
public class QueueWebService
{
	...
	{
		ArrayList<AppointmentQueueTo1> list = new ArrayList<>();
		list.add(new AppointmentQueueTo1("0", "Back End Magic", 128, "#27ae60"));
		list.add(new AppointmentQueueTo1("1", "Short queue", 24, "#f39c12"));
		list.add(new AppointmentQueueTo1("2", "Magic Mike", 128, "#e74c3c"));
