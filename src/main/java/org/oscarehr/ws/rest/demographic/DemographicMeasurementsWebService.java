...
public class DemographicMeasurementsWebService extends AbstractServiceImpl
{
	...
	{
		securityInfoManager.requireAllPrivilege(getLoggedInProviderId(), Permission.MEASUREMENT_READ);
		return RestSearchResponse.successResponseOnePage(measurementsService.getMeasurements(demographicId));
	}
}
