...
public final class DrugTransfer {
	...
	public void setSpecialInstruction(String special_instruction)
	{
	...
	public static DrugTransfer toTransfer(Drug drug) 
	{
		...
		DrugTransfer drugTransfer = new DrugTransfer();

		BeanUtils.copyProperties(drug, drugTransfer);
