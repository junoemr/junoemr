...
public class DashboardWs extends AbstractWs
{
	...
	public void addBillingRecord(BillingTransfer billingTransfer)
	{
	...
	public void addBillingRecords(BillingTransfer[] billingTransfers)
	{
		for(BillingTransfer billingTransfer: billingTransfers)
		{
			addBillingRecord(billingTransfer);
		}
	}
