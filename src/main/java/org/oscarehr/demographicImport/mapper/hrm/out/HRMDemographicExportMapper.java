...
public class HRMDemographicExportMapper extends AbstractHRMExportMapper<CDSDemographicInterface, PatientRecord>
{
	...
	protected List<Address> getExportAddresses(List<org.oscarehr.demographicImport.model.common.Address> addressList)
	{
		List<Address> exportAddressList = new ArrayList<>(addressList.size());
		for(org.oscarehr.demographicImport.model.common.Address address : addressList)
		{
	...
	protected Address toHrmAddress(org.oscarehr.demographicImport.model.common.Address addressModel, AddressType addressType)
	{
