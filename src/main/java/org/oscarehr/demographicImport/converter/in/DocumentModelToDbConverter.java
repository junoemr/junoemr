...
@Component
public class DocumentModelToDbConverter extends BaseModelToDbConverter<org.oscarehr.demographicImport.model.document.Document, Document>
{
	@Override
	public Document convert(org.oscarehr.demographicImport.model.document.Document input)
	{
	...
	private char getDocumentStatus(org.oscarehr.demographicImport.model.document.Document.STATUS status)
	{
