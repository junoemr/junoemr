 ...
 * Canada
 */
package org.oscarehr.demographicImport.converter.out.contact;
...
import static org.oscarehr.demographicImport.model.contact.DemographicContact.CATEGORY;

@Component
public class DemographicContactDbToModelConverter extends
		BaseDbToModelConverter<DemographicContact, org.oscarehr.demographicImport.model.contact.DemographicContact>
{
	@Autowired
	...
	@Override
	public org.oscarehr.demographicImport.model.contact.DemographicContact convert(DemographicContact input)
	{
		if(input == null)
		{
			return null;
		...
		org.oscarehr.demographicImport.model.contact.DemographicContact demographicContact =
				new org.oscarehr.demographicImport.model.contact.DemographicContact(contact);
