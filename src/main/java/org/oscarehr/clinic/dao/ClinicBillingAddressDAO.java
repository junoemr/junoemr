...
package org.oscarehr.clinic.dao;
 ...
 */
@Repository
public class ClinicBillingAddressDAO extends AbstractDao<ClinicBillingAddress>
{
    ...
    public void save(ClinicBillingAddress clinicBillingAddress)
    {
        ...
        {
            merge(clinicBillingAddress);
        }
        else
        {
            persist(clinicBillingAddress);
        }
    }
