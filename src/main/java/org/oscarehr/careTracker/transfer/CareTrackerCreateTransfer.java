...
@Data
public class CareTrackerCreateTransfer extends AbstractTransientModel
{
	private String name;
	private String description;
	private boolean enabled;
	private List<CareTrackerItemGroupCreateUpdateTransfer> careTrackerItemGroups;
	private List<DxCode> triggerCodes;

	public CareTrackerCreateTransfer()
	{
