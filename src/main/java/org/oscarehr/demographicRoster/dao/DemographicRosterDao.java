...
@Repository
public class DemographicRosterDao extends AbstractDao<DemographicRoster>
{
	protected DemographicRosterDao()
	{
	...
	public List<DemographicRoster> findByDemographic(Integer demographicNo)
	{
		...
		return (List<DemographicRoster>)query.getResultList();
	}
}
