							...
							<div class="col-md-6">
								<div class="flex-row flex-gap-8 align-items-center">
									...
									<div class="flex-col align-items-end">
										<juno-check-box class="m-b-4" ng-model="eventData.critical" label="Critical">
										</juno-check-box>
										<juno-select ng-model="eventData.virtualAppointmentType"
										             options="virtualAppointmentOptions"
										             disabled="telehealthMode === TELEHEALTH_MODES.NONE || telehealthMode === TELEHEALTH_MODES.NO_CONNECTION || eventController.editMode"
