...
--%>
<div class="flexV schedule-modal modal-background">
	<div class="flexH schedule-modal-header modal-header">
	...
	<form ng-submit="save()" class="schedule-modal-body event" ng-init="init()">
