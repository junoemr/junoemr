...
angular.module('Admin.Section.MhaConfig').component('integrationList',
	{
		templateUrl: 'src/admin/section/mhaConfig/components/integrationList/integrationList.jsp',
		bindings: {
			componentStyle: "<?"
		},
		controller: [
