...
export default class MeasurementTransferToModelConverter extends AbstractConverter<Measurement, MeasurementModel>
{
	public convert(measurement: Measurement): MeasurementModel
	{
		if (!measurement)
		{
			return null;
