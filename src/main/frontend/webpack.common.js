...
/*			'./node_modules/cp-calendar/module.js',
			...
			*/
			...
			'./src/common/components/junoSelectSave/junoSelectSaveComponent.js',
			...
			'./src/admin/integration/iceFall/activity/iceFallAdminActivityComponent.js',
            './src/admin/integration/imdHealth/imdHealthAdminComponent.js',
            './src/admin/integration/imdHealth/imdHealthLandingComponent.js',
