...
/*			'./node_modules/cp-calendar/module.js',
			...
			*/
			...
			'./src/admin/section/hrm/index/HRMIndexComponent.js',
			'./src/admin/section/hrm/admin/HRMAdminComponent.js',
			'./src/admin/section/hrm/settings/HRMSettingsComponent.js',
			'./src/admin/section/hrm/category/HRMCategoryComponent.js',
			'./src/admin/section/hrm/categoryDetailsModal/categoryDetailsModalComponent.js',
